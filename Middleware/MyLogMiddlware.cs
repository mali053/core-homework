...
public class MyLogMiddleware
{
    ...
    public async Task Invoke(HttpContext c)
    {
        ...
        sw.Start();
        await next.Invoke(c);
        WriteToFile($" date: {DateTime.Now.Date }, beginning time: {DateTime.Now.TimeOfDay}, controller name: {c.Request.Path}, action: {c.Request.Method},"
